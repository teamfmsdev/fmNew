...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2019 at 01:54 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `scheduleJob` (IN `userDate` DATE, IN `userFmNo` INT)  BEGIN
SELECT `row` into @rowExist FROM `ms`.`main` WHERE `row`=userFmNo;


IF(@rowExist!=0) THEN

UPDATE `ccfm`.`bia` SET `date`=DATE(userDate) WHERE `fmNo`=userFmNo;

SELECT ROW_COUNT() INTO @alreadyScheduled;

UPDATE `ccfm`.`biaschedule` SET `description`=CONCAT(`description`,CONCAT('\n\n***Job rescheduled to ',DATE_FORMAT(userDate,'%d-%m-%Y'))), `status`='Scheduled' WHERE `fmNo`=userFmNo;

IF(@alreadyScheduled=0)THEN

INSERT `ccfm`.`bia` VALUES(userDate,DEFAULT,userFmNo);

UPDATE `ccfm`.`biaschedule` SET `description`=CONCAT(`description`,CONCAT('\n\n***Job scheduled on ',DATE_FORMAT(userDate,'%d-%m-%Y'))), `status`='Scheduled' WHERE `fmNo`=userFmNo;
...
INSERT INTO `bia` (`date`, `row`, `fmNo`) VALUES
('2019-03-15', 3, '1'),
('2019-03-24', 4, '235'),
('2019-04-01', 5, '232'),
('2019-04-02', 6, '230'),
...
--
-- Stand-in structure for view `biaschedule`
-- (See below for the actual view)
--
CREATE TABLE `biaschedule` (
`date` date
,`row` int(32)
,`fmNo` text
,`priority` text
...
('2020-04-01', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-02', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-03', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-04', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-05', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-06', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-07', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-08', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-09', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-10', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-11', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-12', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-13', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-14', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-15', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-16', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-17', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-18', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-19', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-20', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-21', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-22', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-23', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-24', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-25', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-26', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-27', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-28', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-29', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2020-04-30', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-01', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-02', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-03', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-04', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-05', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-06', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-07', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-08', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-09', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-10', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-11', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-12', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-13', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-14', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-15', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-16', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-17', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-18', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-19', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-20', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-21', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-22', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-23', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-24', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-25', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-26', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-27', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-28', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-29', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0'),
('2022-04-30', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0', 'p0');
...
('2019-01-02', 66, '21923', 'Grass spray poisoning Lot M', 'NR'),
('2019-01-02', 67, '21924', 'Grass cutting', 'NR'),
('2019-01-02', 68, '30067', 'Grass spray poisoning Lot M', 'R'),
('2019-01-02', 69, '61001', 'Grass Manual Pulling', 'NR'),
...
('2019-01-03', 74, '21923', 'Grass spray poisoning Lot M', 'NR'),
('2019-01-03', 75, '21924', 'Grass cutting', 'NR'),
('2019-01-03', 76, '30067', 'Grass spray poisoning Lot M', 'NR'),
('2019-01-03', 77, '61001', 'Grass Manual Pulling', 'NR'),
('2019-01-03', 78, '38371', 'Dismantle scaffolding at CR3 Olefins', 'NR'),
('2019-01-03', 79, '40607', 'Repair PAMC 5 at Utilities', 'NR'),
('2019-01-03', 80, '40606', 'Repair PAMC 3 at Utilities', 'R'),
...
('2019-01-09', 106, '44055', 'SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS', 'NR'),
...
('2019-01-02', 282, '21923', 'Grass spray poisoning Lot M', 'NR'),
('2019-01-02', 283, '30067', 'Grass spray poisoning Lot M', 'NR'),
('2019-01-04', 284, '40606', 'Repair PAMC 3 at Utilities', 'R'),
('2019-01-02', 287, '30067', 'Grass spray poisoning Lot M', 'R'),
('2019-01-05', 288, '40606', 'Repair PAMC 3 at Utilities', 'R'),
('2019-01-05', 289, '40606', 'Repair PAMC 3 at Utilities', 'R'),
('2019-01-05', 290, '40606', 'Repair PAMC 3 at Utilities', 'R'),
('2019-01-12', 295, '', '', 'NR'),
('2019-01-11', 296, '', '', 'R'),
('2019-01-12', 297, '', '', 'R'),
('2019-04-01', 329, '11', 'ass', 'NR'),
('2019-04-01', 330, '22', 'bss', 'NR'),
('2019-04-01', 331, '33', 'css', 'NR'),
('2019-04-01', 332, '44', 'dss', 'NR'),
('2019-03-01', 344, '1', '2', 'R'),
('2019-03-01', 345, '3', '4', 'R'),
('2019-03-01', 346, '5', '6', 'R'),
('2019-03-02', 347, '55', '66', 'R'),
('2019-03-02', 348, '33', '44', 'R'),
('2019-03-02', 349, '11', '22', 'R');

-- --------------------------------------------------------

--
-- Structure for view `biaschedule`
--
DROP TABLE IF EXISTS `biaschedule`;

CREATE ALGORITHM=UNDEFINED DEFINER=`drv`@`localhost` SQL SECURITY DEFINER VIEW `biaschedule`  AS  select `bia`.`date` AS `date`,`bia`.`row` AS `row`,`bia`.`fmNo` AS `fmNo`,`ms`.`main`.`Priority` AS `priority`,`ms`.`main`.`Work Title` AS `activities`,`ms`.`main`.`Description` AS `description`,`ms`.`main`.`Status` AS `status`,`ms`.`main`.`Closed By` AS `closedBy`,`ms`.`main`.`Completion Date` AS `completionDate` from (`bia` join `ms`.`main` on((`bia`.`fmNo` = `ms`.`main`.`row`))) ;
...
--
ALTER TABLE `bia`
  MODIFY `row` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `ptw`
  MODIFY `row` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=350;
